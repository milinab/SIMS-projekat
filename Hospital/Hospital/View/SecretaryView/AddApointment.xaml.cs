...
namespace Hospital.View.SecretaryView
{
    ...
    public partial class AddAppointment : Page
    {
        ...
        private App _app;
        private readonly AppointmentPage _appointmentPage;

        public AddAppointment(AppointmentPage appointmentsPage)
        {
            _app = Application.Current as App;
            InitializeComponent();
            _appointmentPage = appointmentsPage;
